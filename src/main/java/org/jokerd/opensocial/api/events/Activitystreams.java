 ...
 * @author kotelnikov
 */
public class Activitystreams extends Service {
    ...
    public static class Get extends ServiceCall {
        ...
        private static IJsonValueFactory<Collection<ActivityEntry>> COLLECTION_FACTORY = Collection
            .getCollectionFactory(ActivityEntry.FACTORY);

        /**
         * @param activities
         * @return a list of resulting collection
         */
        public static Collection<ActivityEntry> newActivities(
            List<ActivityEntry> activities) {
            Collection<ActivityEntry> collection = new Collection<ActivityEntry>(
                ActivityEntry.FACTORY);
         ...
         */
        public Collection<ActivityEntry> getActivities() {
            RpcError error = getResultError();
            if (error != null) {
                return null;
            }
            Collection<ActivityEntry> result = getResultObject(COLLECTION_FACTORY);
            return result;
        }
         ...
         * @return this request
         */
        public Get setActivities(Collection<ActivityEntry> collection) {
            reply(collection);
            return this;
        }
         ...
         * @return this request
         */
        public Get setActivities(List<ActivityEntry> activities) {
            Collection<ActivityEntry> collection = newActivities(activities);
